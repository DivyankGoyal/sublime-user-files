...
#define cout if(freeopen() && ++mem&&mem>110000){cout<<"Line:"<<__LINE__<<" "<<"MLE";exit(0);}else cout
#define cin if(freeopen() && ++mem&&mem>110000){cout<<"Line:"<<__LINE__<<" "<<"MLE";exit(0);}else cin
